...
namespace SWS
{
    ...
    public class navMove : MonoBehaviour
    {
        ...
        /// <summary>
        public PathManager pathContainer, pathContainer2;
        ...
        {
            pathContainer = GamePlayManager.instance.MyLevelSetting[GameManager.Instance.SelectedLevel-1].wayPoint.GetComponent<PathManager>();
